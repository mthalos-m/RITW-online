...
const protocols = [
    ...
    },
    {
        ...
        mermaidLines: [
            ...
            'A ~~~ B ~~~ D ~~~ M',
            'end',
            'C["Content <b>C</b><br/>(an image, a sound, or \'cat nearby\')"]',
    ...
    },
    {
        ...
        mermaidLines: [
            ...
            'JESUS["PERCEPT: <b>⚑ \'Jesus\'</b> (surprising match)"]',
            'PH1["Phase 1: Suspend and reprocess (Plan A)"]',
            'STAMP["<b>⚑ Jesus</b>  [time / place stamp]"]',
            'PAT --> JESUS',
            'KF --> JESUS',
            'JESUS -->|"surprise"| PH1',
            'PH1 -.->|"reprocess"| PAT',
    ...
    },
    {
        ...
        mermaidLines: [
            ...
            'NF["¬Fα"]',
            'SC(["Self-concept: <b>Fα</b><br/>(expectation)"])',
            'CHK{"Unresolved?"}',
            'BEH["F-ish behavior"]',
            'AFF(["Self-affirmation <b>Fα!!</b>"])',
    ...
    },
    {
        ...
        mermaidLines: [
            'IN["Information absorbed socially"]',
            'NG["¬Gα"]',
            'CI(["Cult-instilled identity: <b>Gα</b><br/>(expectation)"])',
            'CHK{"Unresolved?"}',
            'BEH["G-ish behavior"]',
            'AFF(["Self-affirmation <b>Gα!!</b>"])',
    ...
    },
    {
        ...
        mermaidLines: [
            ...
            'A ~~~ B ~~~ D ~~~ M',
            'end',
            'C["Content <b>C</b>:<br/>relative frequency of the feature in the population<br/>(recency effects may apply)"]',
            'AW["not routinely flagged up<br/>for explicit awareness"]',
